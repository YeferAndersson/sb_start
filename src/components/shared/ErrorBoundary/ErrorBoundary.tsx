...
import { PiWarningOctagonBold, PiArrowClockwiseBold, PiArrowLeftBold } from 'react-icons/pi'
...
class ErrorBoundary extends Component<Props, State> {
    ...
    <motion.div
        ...
        className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 text-center relative"
    >
