...
// Helper functions
const formatNombreCompleto = (nombres: string | null, apellidos: string | null): string => {
...
const Completar = () => {
    ...
    const [selectedSublinea, setSelectedSublinea] = useState<number | null>(null)
    const [selectedAsesor, setSelectedAsesor] = useState<number | null>(null)
    const [selectedCoasesor, setSelectedCoasesor] = useState<number | null>(null)
    ...
    const [archivos, setArchivos] = useState<{ file: File; tipoId: number; tipoNombre: string }[]>([])
    ...
    useEffect(() => {
        const cargarDatos = async () => {
            ...
            try {
                ...
                const [sublineasData, coasesoresData, tiposArchivosData] = await Promise.all([
                    getSublineasByCarrera(activeCareer.estructuraAcademica.carrera.id),
                    getCoasesoresActivos(),
                    getTiposArchivosEtapa1(),
                ])
    ...
    useEffect(() => {
        const cargarDocentes = async () => {
            ...
            try {
                const docentesData = await getDocentesBySublinea(selectedSublinea)
    ...
    const isStep2Valid = () => {
        return tiposArchivos.filter(t => t.obligatorio).every(t => archivos.some(a => a.tipoId === t.id))
    }

    // Validar formulario completo
    const isFormValid = () => {
        return tramiteActual && userData?.uuid && isStep1Valid() && isStep2Valid()
    }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await completarEtapa1(tramiteActual.id, tramiteActual.codigo_proyecto, userData.uuid, completarData)
    ...
    if (loading || careerLoading) {
        return (
                ...
                <div className='text-center'>
                    <Spinner size={40} />
                    <p className='mt-4 text-white font-medium'>Cargando información...</p>
                </div>
                    ...
                    <div className='flex items-center justify-between'>
                        <div>
                            ...
                            <p className='text-lg text-gray-300'>
                                Proporciona toda la información necesaria para finalizar la primera etapa.
                            </p>
                        </div>
                    </div>
                </motion.div>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex items-center space-x-4'>
                                <div className='w-12 h-12 bg-blue-500  dark:bg-blue-500  rounded-xl flex items-center justify-center'>
                                    <FaGraduationCap className='text-white dark:text-white' size={20} />
                                </div>
                                <div>
                            ...
                            <div className='text-right'>
                                <p className='text-sm text-gray-500 dark:text-gray-400'>Etapa Actual</p>
                        ...
                        <div className='flex items-center justify-center space-x-4'>
                            ...
                            <div className='flex items-center'>
                                <div
                                    ...
                                    {isStep1Valid() ? <FaCheck size={16} /> : '1'}
                                </div>
                                <span
                                    className={`ml-2 font-medium ${
                                        currentStep >= 1 ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500'
                                    }`}>
                            ...
                            <div
                                className={`w-16 h-1 rounded transition-all duration-300 ${
                                    currentStep > 1 ? 'bg-blue-500' : 'bg-gray-200 dark:bg-gray-600'
                                }`}
                            />
                            ...
                            <div className='flex items-center'>
                                <div
                                    ...
                                    {isStep2Valid() ? <FaCheck size={16} /> : '2'}
                                </div>
                                <span
                                    className={`ml-2 font-medium ${
                                        currentStep >= 2 ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500'
                                    }`}>
                                    Documentos
                                </span>
                            </div>
                            ...
                            <div className='p-8'>
                                <div className='mb-8'>
                                    ...
                                    <p className='text-gray-600 dark:text-gray-300'>
                                        Completa los metadatos y detalles académicos de tu proyecto de tesis.
                                    </p>
                                </div>
                                ...
                                <div className='space-y-8'>
                                    ...
                                    <div className='grid grid-cols-1 xl:grid-cols-3 gap-6'>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={e =>
                                                    setSelectedAsesor(e.target.value ? parseInt(e.target.value) : null)
                                                }
                                    ...
                                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                                        <div>
                                            ...
                                            <select
                                                ...
                                                {coasesores
                                                    .filter(c => c.id !== selectedAsesor)
                                                    .map(coasesor => (
                                                        <option key={coasesor.id} value={coasesor.id}>
                                                            {formatNombreCompleto(
                                                                coasesor.investigador.usuario.nombres,
                                                                coasesor.investigador.usuario.apellidos,
                                                            )}
                                                        </option>
                                                    ))}
                                            </select>
                                        ...
                                        <div>
                                            <label className='flex items-center space-x-2 text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3'>
                                                ...
                                                <span>Presupuesto Estimado (S/.) *</span>
                                            </label>
                                            <input
                                                type='number'
                                                min='0'
                                    ...
                                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                                        ...
                                        <div>
                                            <label className='flex items-center space-x-2 text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3'>
                                                <FaFileAlt className='text-orange-500' size={16} />
                                        ...
                                        <div>
                                            <label className='flex items-center space-x-2 text-sm font-semibold text-gray-700 dark:text-gray-200 mb-3'>
                                                ...
                                                <span>Palabras Clave * (min. 3, máx. 10)</span>
                                            </label>
                                            <div className='space-y-3'>
                                                ...
                                                <div className='flex justify-between text-xs'>
                                                    ...
                                                    <span
                                                        ...
                                                        {keywords.length >= 3 ? '✓ Completado' : 'Mínimo 3 requeridas'}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className='p-8'>
                                ...
                                <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8'>
                                    {tiposArchivos.map(tipo => {
                                        const archivoSubido = archivos.find(a => a.tipoId === tipo.id)
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                onDragEnter={e => handleDragEnter(e, tipo.id)}
                                                onDragLeave={e => handleDragLeave(e, tipo.id)}
                                                ...
                                                <div className='text-center'>
                                                    ...
                                                    <h4 className='font-semibold text-gray-900 dark:text-gray-100 mb-2'>
                                                        {tipo.nombre}{' '}
                                                        {tipo.obligatorio && <span className='text-red-500'>*</span>}
                                                    </h4>

                                                    <p className='text-sm text-gray-600 dark:text-gray-300 mb-4'>
                                                        {formatDescripcionArchivo(tipo.descripcion)}
                                                    </p>
                                                    ...
                                                    <div className='flex justify-center space-x-4 text-xs text-gray-500 dark:text-gray-400 mb-4'>
                                                        ...
                                                        <span>•</span>
                                                        <span>{tipo.id === 1 ? 'DOC/DOCX' : 'PDF'}</span>
                                                    </div>
                                                        ...
                                                        <div className='space-y-3'>
                                                            <label className='cursor-pointer inline-flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 hover:shadow-lg'>
                                                                ...
                                                                <input
                                                                    type='file'
                                                                    className='hidden'
                                                                    accept={tipo.id === 1 ? '.doc,.docx' : '.pdf'}
                                                                    onChange={e => {
                                                                        const file = e.target.files?.[0]
                                                                        if (file) {
                                                                            handleFileUpload(file, tipo.id)
                                                                        }
                                                                    }}
                                                                />
                                                            </label>
                                    ...
                                    <div className='bg-white  dark:bg-gray-700 rounded-xl p-4 mb-8'>
                                        <div className='flex items-center justify-between mb-2'>
                                            ...
                                            <span className='text-sm text-gray-500 dark:text-gray-300'>
                                                {archivos.length}/{tiposArchivos.filter(t => t.obligatorio).length}{' '}
                                                obligatorios
                                            </span>
                                        </div>
                        ...
                        <motion.div
                            ...
                            <div className='flex space-x-3'>
                                ...
                                <div className='text-amber-700 dark:text-amber-200 text-sm'>
                                    <p className='font-medium mb-2'>Campos requeridos pendientes:</p>
                                    <div className='grid grid-cols-1 md:grid-cols-2 gap-1 text-xs'>
                                        {!selectedSublinea && <div>• Línea de investigación</div>}
                                        {!selectedAsesor && <div>• Asesor principal</div>}
                                        {!metadatos.titulo.trim() && <div>• Título del proyecto</div>}
                                        {!metadatos.abstract.trim() && <div>• Resumen</div>}
                                        {keywords.length < 3 && <div>• Mínimo 3 palabras clave</div>}
                                        {metadatos.presupuesto <= 0 && <div>• Presupuesto estimado</div>}
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            <div className='flex space-x-3'>
                                ...
                                <div className='text-orange-700 dark:text-orange-200 text-sm'>
                                    <p className='font-medium mb-2'>Documentos obligatorios faltantes:</p>
                                    <div className='space-y-1 text-xs'>
                                        {tiposArchivos
                                            .filter(t => t.obligatorio && !archivos.some(a => a.tipoId === t.id))
                                            .map(tipo => (
                                                <div key={tipo.id}>• {tipo.nombre}</div>
                                            ))}
                                    </div>
                                </div>
                            </div>
                            ...
                            <motion.div
                                ...
                                <div className='text-center'>
                                    ...
                                    <p className='text-gray-600 dark:text-gray-300 mb-6 leading-relaxed'>
                                        ¿Estás seguro de finalizar la <strong>Etapa 1</strong>? Esta acción no se puede
                                        deshacer y tu proyecto pasará a revisión de formato.
                                    </p>
                                    <div className='flex space-x-3'>
                                        <button
