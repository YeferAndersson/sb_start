            ...
            <div className="flex flex-col min-h-screen pt-20 md:pt-40 relative overflow-hidden">
                <div>
                    <TextGenerateEffect
                        ...
                        words="Sistema Integral de Investigación Científica UNA PUNO "
                    ...
                    >
                        Creada para agilizar procesos de investigación y mejorar la experiencia académica universitaria
                    </motion.p>
                    <motion.div
                        initial={{ opacity: 0, translateY: 40 }}
                        animate={{ opacity: 1, translateY: 0 }}
